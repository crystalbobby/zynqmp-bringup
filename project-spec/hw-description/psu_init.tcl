...
set psu_clock_init_data {
    ...
    mask_write 0XFF180308 0x000018C3 0x000018C3
    ...
    mask_write 0XFF180360 0x0000003C 0x00000014
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180068 0x000000FE 0x00000020
    ...
    mask_write 0XFF18006C 0x000000FE 0x00000020
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x24000000
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x0003E000
		# : LOOPBACK
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD409990 0x000000FF 0x00000000
    ...
    mask_write 0XFD409924 0x000000FF 0x00000082
    ...
    mask_write 0XFD409914 0x000000FF 0x000000FF
    ...
    mask_write 0XFD409940 0x000000FF 0x000000FF
    ...
    mask_write 0XFD410014 0x00000007 0x00000005
		# : CHECKING PLL LOCK
    ...
    mask_write 0XFD410040 0x0000003C 0x00000000
    ...
    mask_write 0XFD410044 0x0000003C 0x00000000
