...
/*##################################################################### */
    ...
    * Selection of SGMII or Non SGMII mode 0: Non SGMII 1: SGMII
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_GEM2_SGMII_MODE                   0x1
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x000018C3U ,0x000018C3U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CLK_CTRL_OFFSET,
		0x000018C3U, 0x000018C3U);
/*##################################################################### */
    ...
    * 00: Tie the PCS signal detect to 0 01: Tie the PCS signal detect to 1 10
    * : Signal detect from the external optical PHY via FMIO 11: Reserved
    *  PSU_IOU_SLCR_GEM_CTRL_GEM2_SGMII_SD                         0x01

    * GEM SGMII Signal Detect control register
    * (OFFSET, MASK, VALUE)      (0XFF180360, 0x0000003CU ,0x00000014U)
    */
	PSU_Mask_Write(IOU_SLCR_GEM_CTRL_OFFSET, 0x0000003CU, 0x00000014U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x24000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x24000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180184, 0x03FFFFFFU ,0x0003E000U)
    */
	PSU_Mask_Write(IOU_SLCR_BANK2_CTRL6_OFFSET,
		0x03FFFFFFU, 0x0003E000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * G1A pll ctr bypass value
    *  PSU_SERDES_L2_TM_ILL12_G1A_PLL_CTR_BYP_VAL                  0x0

    * ill pll counter values
    * (OFFSET, MASK, VALUE)      (0XFD409990, 0x000000FFU ,0x00000000U)
    */
	PSU_Mask_Write(SERDES_L2_TM_ILL12_OFFSET, 0x000000FFU, 0x00000000U);
/*##################################################################### */
    ...
    * E ILL F0 CALCODE bypass value. MPHY : G1a, PCIE : Gen 1, SATA : Gen1 , U
    * SB3 : SS
    *  PSU_SERDES_L2_TM_E_ILL1_ILL_BYPASS_E_CALCODE_F0             0x82

    * epi cal code
    * (OFFSET, MASK, VALUE)      (0XFD409924, 0x000000FFU ,0x00000082U)
    */
	PSU_Mask_Write(SERDES_L2_TM_E_ILL1_OFFSET, 0x000000FFU, 0x00000082U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * IQ ILL polytrim bypass value
    *  PSU_SERDES_L2_TM_IQ_ILL8_ILL_BYPASS_IQ_POLYTRIM_VAL         0xFF

    * iqpi polytrim
    * (OFFSET, MASK, VALUE)      (0XFD409914, 0x000000FFU ,0x000000FFU)
    */
...
/*##################################################################### */
    ...
    * E ILL polytrim bypass value
    *  PSU_SERDES_L2_TM_E_ILL8_ILL_BYPASS_E_POLYTRIM_VAL           0xFF

    * epi polytrim
    * (OFFSET, MASK, VALUE)      (0XFD409940, 0x000000FFU ,0x000000FFU)
    */
	PSU_Mask_Write(SERDES_L2_TM_E_ILL8_OFFSET, 0x000000FFU, 0x000000FFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_SERDES_ICM_CFG1_L2_ICM_CFG                              5

    * ICM Configuration Register 1
    * (OFFSET, MASK, VALUE)      (0XFD410014, 0x00000007U ,0x00000005U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG1_OFFSET, 0x00000007U, 0x00000005U);
/*##################################################################### */
    ...
    * Lane 2 Tx Data Bus Witdh. 0x0 - 10 Bits, 0x1 - 20 Bits, 0x2 - 40 Bits, 0
    * x3 - Reserved. When external encoder is disabled, PHY works in 8/16/32 B
    * its mode respecitively
    *  PSU_SERDES_TX_PROT_BUS_WIDTH_L2_TX_PROT_BUSWIDTH            0x0

    * Tx Data Bus Width Control Register
    * (OFFSET, MASK, VALUE)      (0XFD410040, 0x0000003CU ,0x00000000U)
    */
...
/*##################################################################### */
    ...
    * Lane 2 Rx Data Bus Witdh. 0x0 - 10 Bits, 0x1 - 20 Bits, 0x2 - 40 Bits, 0
    * x3 - Reserved. When external encoder is disabled, PHY works in 8/16/32 B
    * its mode respecitively
    *  PSU_SERDES_RX_PROT_BUS_WIDTH_L2_RX_PROT_BUSWIDTH            0x0

    * Rx Data Bus Width Control Register
    * (OFFSET, MASK, VALUE)      (0XFD410044, 0x0000003CU ,0x00000000U)
    */
